...
# 为何要用组合
# 通过为某一个对象添加属性(属性的值是另外一个类的对象)的方式，可以间接地将两个类关联/整合/组合在一起
# 从而减少类与类之间代码的冗余
